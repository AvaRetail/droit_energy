    ...
    <div className="container-xxl py-5">
        <div className="container">
            ...
            <div className="row g-4 pt-3 portfolio-container wow fadeInUp" >
                <div className="col-lg-4 col-md-6 portfolio-item first"  data-aos="fade-down" data-aos-duration="4500">
                ...
                <div className="col-lg-4 col-md-6 portfolio-item first"  data-aos="fade-up" data-aos-duration="4500">
                    <div className="portfolio-img rounded overflow-hidden">
